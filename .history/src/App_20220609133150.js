...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      productDetailsObjec: JSON.parse(localStorage.getItem("productDetails"))!=={}
  ...
  componentDidUpdate(prevState) {
   if(this.state.productDetailsObject){
    localStorage.setItem(
      "productDetails",
      JSON.stringify(this.state.productDetailsObject)
    );}
    localStorage.setItem(
      "itemsAddedToCart",
  ...
  render() {
    ...
    if (!allDataisLoaded || !techDataisLoaded || !clothingDataisLoaded||!currencyisLoaded||!loadCategories)
      return (
        <div>
          <h1> Loading.... </h1>{" "}
        </div>
                ...
                Categories.categories.map((item , index)=>{
                  ...
                  element={
                    <Category
                      ...
                      sele
                      ctedCurrencyIndex={selectedCurrencyIndex}
