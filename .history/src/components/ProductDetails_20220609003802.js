...
class ProductDetails extends React.Component {
  constructor(props) {
    ...
    this.state = {
      imageIndex: 0,
      product:this.props.product?this.props.product:JSON.parse(localStorage.getItem("productDetails"))
    };
    this.props.getDefaultAttributesSelection(JSON.parse(localStorage.getItem("productDetails")));
  ...
  if(this.props.product)  localStorage.setItem(
      "productDetails",
