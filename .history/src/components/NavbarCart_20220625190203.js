    ...
    return (
      <div className="flex items-center flex-center">
        <CustomDropDownMenu
          ...
          handleCurrencyIndexSelection={this.props.handleCurrencyIndexSelection}
          isFliped={this.props.isFliped}
          selectedOption={this.props.selectedOption}
          productCurrency={this.props.productCurrency}
        />
        <div onClick={() => this.props.onCartClick("esraa")} className="flex bg-dark">
