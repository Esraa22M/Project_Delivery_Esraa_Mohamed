...
class ProductDetails extends React.Component {
  constructor(props) {
   ...
   if(this.state.product.inStock) this.props.getDefaultAttributesSelection(this.state.product);
  }
    ...
    return (
      <>
        <ProductDetailsContainer>
         ...
         <div className="product-wrapper"> <div className="flex flex-column product-out-stock ">
            <div>
              <img
          ...
          {!product.inStock ? <div className="div-2 flex flex-center items-center">OUT OF STOCK</div> : <></>}
</div>
