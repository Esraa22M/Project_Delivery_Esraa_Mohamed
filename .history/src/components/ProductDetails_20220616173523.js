...
class ProductDetails extends React.Component {
  ...
  render() {
    let { selectedCurrencyIndex,getItemsAddedToCart,handleOnLinkClick ,keepButtonActive,attributes,getSelectedProductSelectedAttributes} = this.props;
    ...
    return (
      <>
        <ProductDetailsContainer>
          ...
          getSelectedProductSelectedAttributes={getSelectedProductSelectedAttributes}
          />
        </ProductDetailsContainer>
      </>
    );
