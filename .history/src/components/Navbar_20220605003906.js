...
class Navbar extends React.Component {
  ...
  render() {
    let { cartItemsCount,isFliped ,selectedOption ,productCurrency,links} = this.props;
    return (
      <header>
          ...
          <Nav className="flex items-center flex-space-between">
            <div className="flex">
              <ul className="flex items-center flex-center">
                ...
                <li
                  onClick={() => {
                    this.props.handleOnLinkClick(2);
                    this.props.onCartClick(false);
                  }}
                >
                  <NavLink
            ...
            <div className="flex items-center flex-center">
              ...
              />
              <div onClick={() => this.props.onCartClick("esraa")} className="bg-dark">
