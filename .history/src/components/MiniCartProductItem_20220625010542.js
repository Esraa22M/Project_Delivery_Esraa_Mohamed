...
class MiniCartProductItem extends React.Component {
  render() {
    let {product , index ,keepButtonActive ,selectedCurrencyIndex} = this.props;
    return (
      <article key={index} className="flex  flex-space-between min-product">
        <div className="column-1">
          <div className="product-header flex flex-column items-center">
        ...
        <div className="column-2 flex items-center">
          <CartCounter
            product={product}
