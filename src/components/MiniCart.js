...
class MiniCart extends React.Component {
  ...
  render() {
    ...
    return (
      <MiniCartContainer className={isCartClicked ? "" : "hide"}>
        <Scrollbars style={{ width: 390, height: 500 }} autoHide>
          {itemsAddedToCart.length ? (
            ...
            <div className="flex flex-center items-center"><Title className="flex flex-center ">cart is empty</Title></div>
          )}
        </Scrollbars>
      </MiniCartContainer>
    );
